...
{
    [TRAINER_CLASS_PKMN_TRAINER_1] =    { COMPOUND_STRING("{PKMN} Trainer") }, // Unused
    [TRAINER_CLASS_PKMN_TRAINER_2] =    { COMPOUND_STRING("{PKMN} Trainer") }, // Unused
    [TRAINER_CLASS_HIKER] =             { COMPOUND_STRING("Hiker"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    [TRAINER_CLASS_TEAM_AQUA] =         { COMPOUND_STRING("Team Aqua") },
    [TRAINER_CLASS_PKMN_BREEDER] =      { COMPOUND_STRING("{PKMN} Breeder"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] =       { COMPOUND_STRING("Ace Trainer"), 12, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] =       { COMPOUND_STRING("Bird Keeper"), 8 },
    [TRAINER_CLASS_COLLECTOR] =         { COMPOUND_STRING("Collector"), 15, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] =         { COMPOUND_STRING("Swimmer"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] =        { COMPOUND_STRING("Team Magma") },
    [TRAINER_CLASS_EXPERT] =            { COMPOUND_STRING("Expert"), 10 },
    [TRAINER_CLASS_AQUA_ADMIN] =        { COMPOUND_STRING("Aqua Admin"), 10 },
    [TRAINER_CLASS_BLACK_BELT] =        { COMPOUND_STRING("Black Belt"), 8, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] =       { COMPOUND_STRING("Aqua Leader"), 20, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] =        { COMPOUND_STRING("Hex Maniac"), 6 },
    [TRAINER_CLASS_AROMA_LADY] =        { COMPOUND_STRING("Aroma Lady"), 10 },
    [TRAINER_CLASS_RUIN_MANIAC] =       { COMPOUND_STRING("Ruin Maniac"), 15 },
    [TRAINER_CLASS_INTERVIEWER] =       { COMPOUND_STRING("Interviewers"), 12 },
    [TRAINER_CLASS_TUBER_F] =           { COMPOUND_STRING("Tuber"), 1 },
    [TRAINER_CLASS_TUBER_M] =           { COMPOUND_STRING("Tuber"), 1 },
    [TRAINER_CLASS_LADY] =              { COMPOUND_STRING("Lady"), 50 },
    [TRAINER_CLASS_BEAUTY] =            { COMPOUND_STRING("Beauty"), 20, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_GREAT : BALL_POKE },
    [TRAINER_CLASS_RICH_BOY] =          { COMPOUND_STRING("Rich Boy"), 50 },
    [TRAINER_CLASS_POKEMANIAC] =        { COMPOUND_STRING("Poké Maniac"), 15 },
    [TRAINER_CLASS_GUITARIST] =         { COMPOUND_STRING("Guitarist"), 8 },
    [TRAINER_CLASS_KINDLER] =           { COMPOUND_STRING("Kindler"), 8 },
    [TRAINER_CLASS_CAMPER] =            { COMPOUND_STRING("Camper"), 4 },
    [TRAINER_CLASS_PICNICKER] =         { COMPOUND_STRING("Picnicker"), 4 },
    [TRAINER_CLASS_BUG_MANIAC] =        { COMPOUND_STRING("Bug Maniac"), 15 },
    [TRAINER_CLASS_PSYCHIC] =           { COMPOUND_STRING("Psychic"), 6 },
    [TRAINER_CLASS_GENTLEMAN] =         { COMPOUND_STRING("Gentleman"), 20, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] =        { COMPOUND_STRING("Elite Four"), 25, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] =            { COMPOUND_STRING("Gym Leader"), 25, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    [TRAINER_CLASS_SCHOOL_KID] =        { COMPOUND_STRING("School Kid") },
    [TRAINER_CLASS_SR_AND_JR] =         { COMPOUND_STRING("Teammates"), 4 },
    [TRAINER_CLASS_WINSTRATE] =         { COMPOUND_STRING("Winstrate"), 10 },
    [TRAINER_CLASS_POKEFAN] =           { COMPOUND_STRING("Poké Fan"), 20 },
    [TRAINER_CLASS_YOUNGSTER] =         { COMPOUND_STRING("Youngster"), 4 },
    [TRAINER_CLASS_CHAMPION] =          { COMPOUND_STRING("Champion"), 50, BALL_ULTRA },
    [TRAINER_CLASS_FISHERMAN] =         { COMPOUND_STRING("Fisher"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] =        { COMPOUND_STRING("Triathlete"), 10 },
    [TRAINER_CLASS_DRAGON_TAMER] =      { COMPOUND_STRING("Dragon Tamer"), 12 },
    [TRAINER_CLASS_NINJA_BOY] =         { COMPOUND_STRING("Ninja Boy"), 3 },
    [TRAINER_CLASS_BATTLE_GIRL] =       { COMPOUND_STRING("Battle Girl"), 6 },
    [TRAINER_CLASS_PARASOL_LADY] =      { COMPOUND_STRING("Parasol Lady"), 10 },
    [TRAINER_CLASS_SWIMMER_F] =         { COMPOUND_STRING("Swimmer"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] =             { COMPOUND_STRING("Twins"), 3 },
    [TRAINER_CLASS_SAILOR] =            { COMPOUND_STRING("Sailor"), 8 },
    [TRAINER_CLASS_COOLTRAINER_2] =     { COMPOUND_STRING("Ace Trainer"), 5, BALL_ULTRA }, // Jazmyn
    [TRAINER_CLASS_MAGMA_ADMIN] =       { COMPOUND_STRING("Magma Admin"), 10 },
    [TRAINER_CLASS_RIVAL] =             { COMPOUND_STRING("{PKMN} Trainer"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] =       { COMPOUND_STRING("Bug Catcher"), 4 },
    [TRAINER_CLASS_PKMN_RANGER] =       { COMPOUND_STRING("{PKMN} Ranger"), 12 },
    [TRAINER_CLASS_MAGMA_LEADER] =      { COMPOUND_STRING("Magma Leader"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] =              { COMPOUND_STRING("Lass"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] =      { COMPOUND_STRING("Young Couple"), 8 },
    [TRAINER_CLASS_OLD_COUPLE] =        { COMPOUND_STRING("Old Couple"), 10 },
    [TRAINER_CLASS_SIS_AND_BRO] =       { COMPOUND_STRING("Sis & Bro"), 3 },
    [TRAINER_CLASS_SALON_MAIDEN] =      { COMPOUND_STRING("Salon Maiden"), 5, BALL_ULTRA },
    [TRAINER_CLASS_DOME_ACE] =          { COMPOUND_STRING("Dome Ace") },
    [TRAINER_CLASS_PALACE_MAVEN] =      { COMPOUND_STRING("Palace Maven") },
    [TRAINER_CLASS_ARENA_TYCOON] =      { COMPOUND_STRING("Arena Tycoon") },
    [TRAINER_CLASS_FACTORY_HEAD] =      { COMPOUND_STRING("Factory Head") },
    [TRAINER_CLASS_PIKE_QUEEN] =        { COMPOUND_STRING("Pike Queen") },
    [TRAINER_CLASS_PYRAMID_KING] =      { COMPOUND_STRING("Pyramid King") },
    [TRAINER_CLASS_RS_PROTAG] =         { COMPOUND_STRING("{PKMN} Trainer") },

    [TRAINER_CLASS_YOUNGSTER_FRLG] =       { COMPOUND_STRING("Youngster"), 4 },
    [TRAINER_CLASS_BUG_CATCHER_FRLG] =     { COMPOUND_STRING("Bug Catcher"), 3 },
    [TRAINER_CLASS_LASS_FRLG] =            { COMPOUND_STRING("Lass"), 4 },
    [TRAINER_CLASS_SAILOR_FRLG] =          { COMPOUND_STRING("Sailor"), 8 },
    [TRAINER_CLASS_CAMPER_FRLG] =          { COMPOUND_STRING("Camper") },
    [TRAINER_CLASS_PICNICKER_FRLG] =       { COMPOUND_STRING("Picnicker") },
    [TRAINER_CLASS_POKEMANIAC_FRLG] =      { COMPOUND_STRING("Poké Maniac"), 12 },
    [TRAINER_CLASS_SUPER_NERD_FRLG] =      { COMPOUND_STRING("Super Nerd"), 6 },
    [TRAINER_CLASS_HIKER_FRLG] =           { COMPOUND_STRING("Hiker"), 9, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    [TRAINER_CLASS_BIKER_FRLG] =           { COMPOUND_STRING("Biker") },
    [TRAINER_CLASS_BURGLAR_FRLG] =         { COMPOUND_STRING("Burglar"), 22 },
    [TRAINER_CLASS_ENGINEER_FRLG] =        { COMPOUND_STRING("Engineer"), 12 },
    [TRAINER_CLASS_FISHERMAN_FRLG] =       { COMPOUND_STRING("Fisher"), 9, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_SWIMMER_M_FRLG] =       { COMPOUND_STRING("Swimmer"), 1, BALL_DIVE },
    [TRAINER_CLASS_CUE_BALL_FRLG] =        { COMPOUND_STRING("Roughneck"), 6 },
    [TRAINER_CLASS_GAMER_FRLG] =           { COMPOUND_STRING("Gambler"), 18 },
    [TRAINER_CLASS_BEAUTY_FRLG] =          { COMPOUND_STRING("Beauty"), 18, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_GREAT : BALL_POKE },
    [TRAINER_CLASS_SWIMMER_F_FRLG] =       { COMPOUND_STRING("Swimmer"), 1, BALL_DIVE },
    [TRAINER_CLASS_PSYCHIC_FRLG] =         { COMPOUND_STRING("Psychic") },
    [TRAINER_CLASS_ROCKER_FRLG] =          { COMPOUND_STRING("Rocker"), 6 },
    [TRAINER_CLASS_JUGGLER_FRLG] =         { COMPOUND_STRING("Juggler"), 10 },
    [TRAINER_CLASS_TAMER_FRLG] =           { COMPOUND_STRING("Tamer"), 10 },
    [TRAINER_CLASS_BIRD_KEEPER_FRLG] =     { COMPOUND_STRING("Bird Keeper"), 6 },
    [TRAINER_CLASS_BLACK_BELT_FRLG] =      { COMPOUND_STRING("Black Belt"), 6, BALL_ULTRA },
    [TRAINER_CLASS_RIVAL_EARLY_FRLG] =     { COMPOUND_STRING("Rival"), 4 },
    [TRAINER_CLASS_SCIENTIST_FRLG] =       { COMPOUND_STRING("Scientist"), 12, BALL_REPEAT },
    [TRAINER_CLASS_BOSS_FRLG] =            { COMPOUND_STRING("Rocket Boss"), 25, BALL_MASTER },
    [TRAINER_CLASS_LEADER_FRLG] =          { COMPOUND_STRING("Gym Leader"), 25, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    [TRAINER_CLASS_TEAM_ROCKET_FRLG] =     { COMPOUND_STRING("Team Rocket"), 8 },
    [TRAINER_CLASS_COOLTRAINER_FRLG] =     { COMPOUND_STRING("Ace Trainer"), 9, BALL_ULTRA },
    [TRAINER_CLASS_ELITE_FOUR_FRLG] =      { COMPOUND_STRING("Elite Four"), 25, BALL_ULTRA },
    [TRAINER_CLASS_GENTLEMAN_FRLG] =       { COMPOUND_STRING("Gentleman"), 18, BALL_LUXURY },
    [TRAINER_CLASS_RIVAL_LATE_FRLG] =      { COMPOUND_STRING("Rival"), 9 },
    [TRAINER_CLASS_CHAMPION_FRLG] =        { COMPOUND_STRING("Champion"), 25, BALL_ULTRA },
    [TRAINER_CLASS_CHANNELER_FRLG] =       { COMPOUND_STRING("Channeler"), 8 },
    [TRAINER_CLASS_TWINS_FRLG] =           { COMPOUND_STRING("Twins"), 3 },
    [TRAINER_CLASS_COOL_COUPLE_FRLG] =     { COMPOUND_STRING("Cool Couple"), 6 },
    [TRAINER_CLASS_YOUNG_COUPLE_FRLG] =    { COMPOUND_STRING("Young Couple"), 7 },
    [TRAINER_CLASS_CRUSH_KIN_FRLG] =       { COMPOUND_STRING("Crush Kin"), 6 },
    [TRAINER_CLASS_SIS_AND_BRO_FRLG] =     { COMPOUND_STRING("Sis & Bro"), 1 },
    [TRAINER_CLASS_PKMN_PROF_FRLG] =       { COMPOUND_STRING("{PKMN} Prof."), 25 },
    [TRAINER_CLASS_PLAYER_FRLG] =          { COMPOUND_STRING("{PKMN} Trainer"), 1 },
    [TRAINER_CLASS_CRUSH_GIRL_FRLG] =      { COMPOUND_STRING("Crush Girl"), 6 },
    [TRAINER_CLASS_TUBER_FRLG] =           { COMPOUND_STRING("Tuber"), 1 },
    [TRAINER_CLASS_PKMN_BREEDER_FRLG] =    { COMPOUND_STRING("{PKMN} Breeder"), 7, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_PKMN_RANGER_FRLG] =     { COMPOUND_STRING("{PKMN} Ranger"), 9 },
    [TRAINER_CLASS_AROMA_LADY_FRLG] =      { COMPOUND_STRING("Aroma Lady"), 7 },
...
u8 CreateNPCTrainerPartyFromTrainer(struct Pokemon *party, const struct Trainer *trainer, bool32 halfTeam, u32 battleTypeFlags)
{
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (s32 i = 0; i < monsCount; i++)
        {
            ...
            if (trainer->gender == TRAINER_GENDER_OTHER)
