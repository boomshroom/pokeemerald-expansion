...
static void PrintMonInfo(u32 num, u32, u32 owned, u32 newEntry, bool32 blankName);
...
static bool8 LoadPokedexListPage(u8 page)
{
    ...
    case 3:
        ...
        if (sPokedexView->originalSearchSelectionNum != 0)
        {
            ...
            sPokedexListItem->silhouette = GetSetPokedexFlag(sPokedexView->originalSearchSelectionNum, FLAG_GET_SILHOUETTE);
