...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_CHARJABUG] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_VIKAVOLT, CONDITIONS({IF_IN_AURA, MAP_AURA_CHARGED})},
    ...
    [SPECIES_CRABRAWLER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_CRABOMINABLE, CONDITIONS({IF_IN_AURA, MAP_AURA_ICY})},
