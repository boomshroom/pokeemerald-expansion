...
#define B_FLAG_VICTORY_CATCH_GUARANTEED FLAG_CUSTOM_VICTORY_CATCH // If set, you will be prompted to throw a ball after the encounter has been defeated, guaranteed to catch. You can't capture the encounter in any other way.
...
#define B_TRAINER_MON_RANDOM_ABILITY    TRUE       // If set to TRUE, a random legal Ability will be generated for Trainers' Pokémon.
