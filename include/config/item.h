...
#define VAR_LAST_REPEL_LURE_USED    VAR_UNUSED_0x40F7 // If this var has been assigned, the last Repel/Lure used will be saved and the player will be prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
...
#define I_ORAS_DOWSING_FLAG         FLAG_CUSTOM_DOWSING_MACHINE // Replace 0 with an unused flag to enable the Dowsing Machine mechanic from ORAS.
