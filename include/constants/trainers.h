...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_ACE_TRAINER_2, // Jazmyn
    ...
    TRAINER_CLASS_FISHERMAN_FRLG = TRAINER_CLASS_FISHER_FRLG, // Gen 1,3-7 name
    ...
    TRAINER_CLASS_GYM_LEADERS, // Exclusively for Tate & Liza
